...
// For now, use 'any' to bypass TypeScript issues until database is set up
type SupabaseInsert = any;
type SupabaseUpdate = any;
...
export const profileService = {
  ...
  async upsertProfile(profile: SupabaseInsert): Promise<SupabaseRow | null> {
    const { data, error } = await supabase
      .from('profiles')
